...
impl DrawTarget for Display<'_> {
        ...
        I: IntoIterator<Item = Pixel<Self::Color>>,
    {
        for Pixel(coord, color) in pixels.into_iter() {
            ...
            let pixel_offset: u32 = coord.y as u32 * self.fb.pitch() as u32 + coord.x as u32 * (self.fb.bpp() as u32 / 8);

            unsafe {
                *(self.fb.addr().add(pixel_offset as usize) as *mut u32) = 
                    (color.r() as u32) << self.fb.red_mask_shift() 
